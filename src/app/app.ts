...
// Fix 1: Removed '.ts' from the import paths
...
@Component({
  ...
  // Fix 2: Added correct opening tags <io-chart ... >
  template: `
    <h1 style="text-align:center; font-family:sans-serif; margin-bottom: 40px;">Frontend Intern Assignment</h1>
